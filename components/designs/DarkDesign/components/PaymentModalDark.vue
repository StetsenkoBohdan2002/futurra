<template>
  <Modal>
    <div class="dark-payment-modal">
      <div class="dark-payment-modal__title font-extrabold text-center">Payment method</div>
      ...
      <fieldset class="dark-payment-modal__group">
        <Input
          :max="19"
          :icon="true"
          :card="true"
...
.paypal {
  background-color: $light-page-paypal;
  width: 100%;
  gap: 10px;
...
.dark-payment-modal .divider {
  ...
  & > div {
    ...
    height: 2px;
    border-radius: 1px;
    background-color: $light-color-thin;
  }
  & > span {
    color: #fff;
    font-size: 12px;
...
.dark-payment-modal .disabled {
  background-color: $dark-field-bg;
  color: $light-color-regular;
  font-weight: bold;
  margin-top: 40px;
  width: 100%;
}
.dark-payment-modal .submit:not(.disabled) {
  background-color: #fff;
  color: $dark-page-button-color;
  font-weight: bold;
  margin-top: 40px;
  width: 100%;
  &:hover {
